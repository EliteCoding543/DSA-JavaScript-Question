...
// Function Call 
p1.sayHi();       // Overriding ye hi h jo alag alg call same fn 
chlid1.sayHi();  // Overriding ye hi h jo alag alg call same fn 
GC.sayHi();      // Overriding ye hi h jo alag alg call same fn 